...
### After the coding we should compile the with GCC comand
```sh
hritik@Hritiks-MacBook-Air ~ % gcc cse316.c
```
### After compiling need to run the code with the file name
```sh
hritik@Hritiks-MacBook-Air ~ % ./a.out
```
